...
export default function Card({ data }: CardProps) {
  return (
    ...
    >
      ...
      <div className="ease flex h-36 items-center overflow-hidden rounded border-2 border-gray-100 bg-white transition-all duration-200 focus:border-black active:border-black md:h-48 lg:hidden">
