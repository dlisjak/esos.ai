		...
		<div>
			...
			{subdomain == 'demo' && (
				<div
					...
					} max-w-screen-lg xl:mx-auto mx-5 rounded px-5 lg:pt-3 pt-0 pb-3 flex flex-col lg:flex-row space-y-3 lg:space-y-0 justify-between items-center sticky bottom-5 bg-white border-t-4 border-black
          drop-shadow-lg transition-all ease-in-out duration-150`}
				>
					...
					>
						<Link
							className="flex-auto text-lg rounded py-1 sm:py-3 px-5 text-black border border-gray-200 hover:border-black transition-all ease-in-out duration-150 whitespace-no-wrap"
